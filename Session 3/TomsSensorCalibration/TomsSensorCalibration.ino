...
void loop() {
  ...
  /* Printing values for white and black surfaces
  ...
  */
...

  {
    ...
    sensorMapValue1 = map(sensorValue1, sensorBlackValue1, sensorWhiteValue1, 0, 100);  //change to 255 for weighing, 100 for percent
    sensorMapValue2 = map(sensorValue2, sensorBlackValue2, sensorWhiteValue2, 0, 100);
    sensorMapValue3 = map(sensorValue3, sensorBlackValue3, sensorWhiteValue3, 0, 100);
    sensorMapValue4 = map(sensorValue4, sensorBlackValue4, sensorWhiteValue4, 0, 100);

    Serial.println("Map sensor 1");
    Serial.println(sensorMapValue1);
    Serial.println("Map sensor 2");
    Serial.println(sensorMapValue2);
    Serial.println("Map sensor 3");
    Serial.println(sensorMapValue3);
    Serial.println("Map sensor 4");
    Serial.println(sensorMapValue4);
