...
int sensorDistance[4] = {0, 12, 27, 40};
...
void setup() {
  ...
  Kp = 10; //readHMIConst(KP);
  Ki = 0; //readHMIConst(KI);
  Kd = 0;  //readHMIConst(KD);
  ...
  sensorBlackValue1 = 442;
  sensorBlackValue2 = 281;
  sensorBlackValue3 = 146;
  sensorBlackValue4 = 25;

  sensorWhiteValue1 = 705;
  sensorWhiteValue2 = 584;
  sensorWhiteValue3 = 699;
  sensorWhiteValue4 = 160;
...
*/
  ...
  for (i = 0; i < 25; i++)
  {
    ...
    sensorValue3 = sensorValue3 + analogRead(A2); 
    sensorValue4 = sensorValue4 + analogRead(A3); 
    delay(100);
  }

  sensorValue1 = (sensorValue1 / 25); 
  sensorValue2 = (sensorValue2 / 25); 
  sensorValue3 = (sensorValue3 / 25); 
  sensorValue4 = (sensorValue4 / 25); 
  ...
  sensorMapValue1 = map(sensorValue1, sensorBlackValue1, sensorWhiteValue1, 100, 0);  //change to 255 for weighing, 100 for percent
  sensorMapValue2 = map(sensorValue2, sensorBlackValue2, sensorWhiteValue2, 100, 0);
  sensorMapValue3 = map(sensorValue3, sensorBlackValue3, sensorWhiteValue3, 100, 0);
  sensorMapValue4 = map(sensorValue4, sensorBlackValue4, sensorWhiteValue4, 100, 0);

  delay(100);

  int sensorWeight[] = {sensorMapValue1, sensorMapValue2, sensorMapValue3, sensorMapValue4};
  delay(100);
