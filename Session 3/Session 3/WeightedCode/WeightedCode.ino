...
void setup() {
  ...
  int sensorValue1Max = 0;
  int sensorValue2Max = 0;
  int sensorValue3Max = 0;
  int sensorValue4Max = 0;

  int sensorValue1Min = 0;
  int sensorValue2Min = 0;
  int sensorValue3Min = 0;
  int sensorValue4Min = 0;
...
void loop() {
  ...
  if(sensorValue1 > sensorValue1Max) sensorValue1Max = sensorValue1;
  
  if(sensorValue2 > sensorValue2Max) sensorValue2Max = sensorValue2;
